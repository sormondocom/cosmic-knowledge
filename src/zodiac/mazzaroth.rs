...
fn print_sign_card(s: &MazzarothSign) {
    ...
    println!("  {:<22} {}", "Ruling Planet:".bold(),  s.planet.bright_white());
    println!("  {:<22} {}", "Tribe of Israel:".bold(),s.tribe.bright_white());
    println!("  {:<22} {}", "Hebrew Month:".bold(),   s.hebrew_month.bright_white());
    println!("  {:<22} {}", "Sefer Yetzirah Letter:".bold(), s.letter.bright_white());
    println!("  {:<22} {}", "Hoshen Gemstone:".bold(),s.hoshen_stone.bright_white());
...
fn print_summary_table() {
    ...
    println!("{}", "  ║ # ║  ║  Hebrew     ║  English      ║ Elem   ║  Dates        ║".bright_yellow());
    println!("{}", "  ╠═══╬══╬════════════╬══════════════╬════════╬══════════════╣".bright_yellow());
    for s in MAZZAROTH {
        println!("  ║ {:<2}║{}║ {:<12}║ {:<14}║ {:<7}║ {:<14}║",
...
pub fn run_mazzaroth_session() {
    println!();
    println!("{}", "╔════════════════════════════════════════════════════════════╗".bright_yellow());
    println!("{}", "║          ✡  HEBREW MAZZAROTH — מַזָּרוֹת  ✡              ║".bold().bright_yellow());
    println!("{}", "╠════════════════════════════════════════════════════════════╣".bright_yellow());
    println!("{}", "║  The twelve constellations of the sacred zodiac as seen   ║".dimmed());
    println!("{}", "║  through Torah, Sefer Yetzirah, and the Twelve Tribes.    ║".dimmed());
    println!("{}", "╚════════════════════════════════════════════════════════════╝".bright_yellow());

    loop {
        println!();
        println!("  {}", "─ Choose an action ───────────────────────────────────────".dimmed());
        ...
        match buf.trim() {
            "1" => {
                println!();
                println!("{}", "  ── All Twelve Signs of the Mazzaroth ──".bold().bright_yellow());
                print_summary_table();
                println!();
            ...
            "3" => {
                ...
                match sign_for_date(month, day) {
                    ...
                    None    => println!("{}", "  Invalid date — please enter a valid month (1–12) and day.".yellow()),
                }
            }
            "0" | "" => break,
