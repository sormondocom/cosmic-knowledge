...
pub fn run_world_systems_session() {
    loop {
        ...
        println!(
            "{}",
            "║        🌏  WORLD COSMOLOGIES & NUMBER TRADITIONS         ║"
                .bold()
                .bright_green()
        );
        println!(
        ...
        println!(
            "{}",
            "║   1.  🐉  Chinese Cosmology                              ║".bright_yellow()
        );
        println!(
            "{}",
            "║          Nine Star Ki · Wu Xing · Ba Gua · Lucky numbers ║".dimmed()
        );
        println!(
            "{}",
            "║                                                          ║".bright_green()
        ...
        println!(
            "{}",
            "║   2.  🌍  African Traditions                             ║".bright_red()
        );
        println!(
            "{}",
            "║          Yoruba Ifá · Akan Day Names · Kemetic Numbers   ║".dimmed()
        );
        println!(
            "{}",
            "║                                                          ║".bright_green()
